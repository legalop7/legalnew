...
bot = telebot.TeleBot('7011848049:AAFvZxNGlf67n4LnMDh4oOz3WwXhQCq2pqo')
# Admin user IDs
admin_id = ["5612297293"]
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 120:
                response = "You Are On Cooldown ❌. Please Wait 120 sec Before Running The /FUCK Command Again."
                bot.reply_to(message, response)
                return
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /FUCK command.                                                                          DM TO BUY ACCESS:- @LegalMods")
